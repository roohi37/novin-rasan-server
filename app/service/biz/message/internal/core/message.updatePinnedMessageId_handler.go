...
func (c *MessageCore) MessageUpdatePinnedMessageId(in *message.TLMessageUpdatePinnedMessageId) (*mtproto.Bool, error) {
	...
	case mtproto.PEER_CHANNEL:
		// نوین رسان: سرویس Channel در متن‌باز نیست؛ کانال با همان مسیر کاربر/چت.
		c.Logger.Infof("message.updatePinnedMessageId: channel via shared message store (no Channel service)")
	}
