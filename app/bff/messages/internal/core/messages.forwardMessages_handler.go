...
func (c *MessagesCore) makeForwardMessages(
	...
	case mtproto.PEER_CHANNEL:
		// نوین رسان: بدون سرویس Channel؛ خواندن پیام‌های مبدأ از همان جدول مشترک.
		c.Logger.Infof("messages.forwardMessages: channel source %d via shared message store", fromPeer.PeerId)
