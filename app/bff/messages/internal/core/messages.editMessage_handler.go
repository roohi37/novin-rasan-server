...
func (c *MessagesCore) MessagesEditMessage(in *mtproto.TLMessagesEditMessage) (*mtproto.Updates, error) {
	...
	case mtproto.PEER_CHANNEL:
		// نوین رسان: بدون سرویس Channel؛ ویرایش را با همان مسیر کاربر/چت انجام بده.
		c.Logger.Infof("messages.editMessage: channel %d via shared message store", peer.PeerId)
	default:
