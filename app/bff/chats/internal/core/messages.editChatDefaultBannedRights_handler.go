...
func (c *ChatsCore) MessagesEditChatDefaultBannedRights(in *mtproto.TLMessagesEditChatDefaultBannedRights) (*mtproto.Updates, error) {
	...
	case mtproto.PEER_CHANNEL:
		// نوین رسان: مجوزهای کانال بدون سرویس Channel اعمال نمی‌شود؛
		// پاسخ خالیِ معتبر به‌جای خطای Enterprise.
		c.Logger.Infof("messages.editChatDefaultBannedRights: channel %d skipped (no Channel service)", peer.PeerId)
