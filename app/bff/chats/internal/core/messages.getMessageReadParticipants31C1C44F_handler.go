...
func (c *ChatsCore) MessagesGetMessageReadParticipants31C1C44F(in *mtproto.TLMessagesGetMessageReadParticipants31C1C44F) (*mtproto.Vector_ReadParticipantDate, error) {
	...
	case mtproto.PEER_CHANNEL:
		// نوین رسان: بدون سرویس Channel؛ لیست خالی معتبر (نه خطا).
		c.Logger.Infof("messages.getMessageReadParticipants: channel %d returns empty list (no Channel service)", peer.PeerId)
	default:
